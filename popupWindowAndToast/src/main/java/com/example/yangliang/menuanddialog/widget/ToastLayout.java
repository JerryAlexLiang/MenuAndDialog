package com.example.yangliang.menuanddialog.widget;
...
import com.example.yangliang.menuanddialog.utils.DisplayUtil;
...
public class ToastLayout extends RelativeLayout {
    ...
    public ToastLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        view = LayoutInflater.from(getContext()).inflate(R.layout.float_toast_layout, null);
        addView(view);
